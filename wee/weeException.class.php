...
final class weeException extends Namespace
{
	public static function handleError($iNumber, $sMessage, $sFile, $iLine)
	{
		...
		$aTypes = array(1 => 'E_ERROR', 2 => 'E_WARNING', 4 => 'E_PARSE', 8 => 'E_NOTICE', 16 => 'E_CORE_ERROR',
			32 => 'E_CORE_WARNING', 64 => 'E_COMPILE_ERROR', 128 => 'E_COMPILE_WARNING', 256 => 'E_USER_ERROR',
			512 => 'E_USER_WARNING', 1024 => 'E_USER_NOTICE', 2047 => 'E_ALL', 2048 => 'E_STRICT');
		...
		self::logError('error', $sFile, $iLine, $aTypes[$iNumber], $sMessage);
		exit($iNumber);
	}
