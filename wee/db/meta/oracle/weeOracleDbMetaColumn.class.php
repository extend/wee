...
/**
	Oracle specialisation of weeDbMetaColumn.
*/

class weeOracleDbMetaColumn extends weeDbMetaColumn 
	implements weeDbMetaCommentable, weeDbMetaSchemaObject
{
	/**
		Initialise a new oracle column object.
		...
		@param	$oTable	The oracle table of the column.
	*/
