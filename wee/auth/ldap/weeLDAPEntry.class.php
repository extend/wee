...
class weeLDAPEntry implements ArrayAccess
{
	/**
	...
	*/
	...
	public function getAttributes()
	{
		...
		$this->aAttributes	=== false and burn('LDAPException', _WT(ldap_error($this->rLink)));
	...
	*/
	...
	public function getDN()
	{
		...
		$this->sDN	=== false and burn('LDAPException', _WT(ldap_error($this->rLink)));
