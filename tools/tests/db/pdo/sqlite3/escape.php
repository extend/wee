...
// weePDODatabase::escape

$this->isEqual("'egg'", $oDb->escape('egg'),
	_WT('weePDODatabase::escape does not return the expected escaped string.'));

$this->isEqual("'123'", $oDb->escape(123),
	_WT('weePDODatabase::escape does not return the expected escaped integer.'));
...
$this->isEqual("'that''s all folks!'", $oDb->escape("that's all folks!"),
	_WT('weePDODatabase::escape does not return the expected escaped string when it contains single quotes.'));

$this->isEqual('null', $oDb->escape(null),
	_WT('weePDODatabase::escape does not return the expected escaped null value.'));

// weePDODatabase::escapeIdent

$this->isEqual('"egg"', $oDb->escapeIdent('egg'),
	_WT('weePDODatabase::escapeIdent does not return the expected escaped identifier.'));

$this->isEqual('"that""s all folks!"', $oDb->escapeIdent('that"s all folks!'),
	_WT('weePDODatabase::escape does not return the expected escaped identifier when it contains double quotes.'));
