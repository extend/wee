...
try {
	$oDb->escapeIdent('');
	$this->fail(_WT('weePDODatabase::escapeIdent does not throw an InvalidArgumentException when the identifier is empty.'));
} catch(InvalidArgumentException $e) {}

try {
	$oDb->escapeIdent(str_repeat('w', 31));
	$this->fail(_WT('weePDODatabase::escapeIdent does not throw an InvalidArgumentException when the identifier is longer than 30 characters.'));
} catch(InvalidArgumentException $e) {}
