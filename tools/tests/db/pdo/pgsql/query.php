...
foreach ($oResults as $aRow)
{
	...
	$this->isFalse(empty($aRow['q_id']), 'The field q_id should not be empty.');
}
...
foreach ($oResults as $aRow)
{
	$this->isInstanceOf($aRow, 'weePDOResult_pgsql_testForeach', 'The returned row should be an instance of weePDOResult_pgsql_testForeach.');
	$this->isFalse(empty($aRow), 'The returned row should not be empty.');
	$this->isFalse(empty($aRow['q_id']), 'The field q_id should not be empty.');
}
